...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [529],
  {
      ...
      let r = !0,
        ...
        u = (t) => {
          ((s = !1),
            (n.frameData.delta = r
              ? 1e3 / 60
              : Math.max(Math.min(t - n.frameData.timestamp, 40), 1)),
        ...
        c = o.reduce((t, e) => {
          let i = a[e];
          return (
            (t[e] = (t, e = !1, n = !1) => (s || h(), i.schedule(t, e, n))),
            t
          );
        }, {});
      function d(t) {
    ...
    4146: function (t, e, i) {
      ...
      var F = i(1649),
        B = i(6190);
      let O = { ...F.Rx, transform: Math.round },
        I = {
          borderWidth: B.px,
          borderTopWidth: B.px,
      ...
      function U(t, e, i) {
        for (let n in e) M(e[n]) || D(n, i) || (t[n] = e[n]);
      }
      let N = new Set([
        "animate",
        "exit",
      ...
      try {
        (n = require("@emotion/is-prop-valid").default) &&
          (H = (t) => (t.startsWith("on") ? !z(t) : n(t)));
      } catch (t) {}
      function Z(t, e, i) {
        return "string" == typeof t ? t : B.px.transform(e + i * t);
      }
      let Y = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
        ...
        (p.transform && (f && (m.transform = p.transform), delete p.transform),
          ...
          void 0 !== o &&
            (function (t, e, i = 1, n = 0, r = !0) {
              t.pathLength = 1;
              let s = r ? Y : q;
              t[s.offset] = B.px.transform(-n);
              let o = B.px.transform(e),
                a = B.px.transform(i);
              t[s.array] = `${o} ${a}`;
            })(p, o, a, l, !1));
      }
      let G = () => ({ ...W(), attrs: {} }),
        K = (t) => "string" == typeof t && "svg" === t.toLowerCase(),
        _ = (t) => t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
      function J(t, { style: e, vars: i }, n, r) {
      ...
      function tt(t, e, i, n) {
        for (let i in (J(t, e, void 0, n), e.attrs))
          t.setAttribute(Q.has(i) ? i : _(i), e.attrs[i]);
      }
      function te(t, e) {
        let { style: i } = t,
          n = {};
        for (let r in i)
          (M(i[r]) || (e.style && M(e.style[r])) || D(r, t)) && (n[r] = i[r]);
        return n;
      }
      function ti(t, e) {
        let i = te(t, e);
      ...
      let tp = (t) =>
        "mouse" === t.pointerType
          ...
          : !1 !== t.isPrimary;
      function tm(t, e = "page") {
        return { point: { x: t[e + "X"], y: t[e + "Y"] } };
      }
      let tf = (t) => (e) => tp(e) && t(e, tm(e));
      function tv(t, e, i, n) {
        return td(t, e, tf(i), n);
      }
      var tg = i(3624);
      function ty(t) {
        let e = null;
      ...
      function tS(t, e) {
        ...
        return tv(
          ...
          (n, r) => {
            if ("touch" === n.type || tA()) return;
            let s = t.getProps();
            (t.animationState &&
              s.whileHover &&
              t.animationState.setActive("whileHover", e),
              s[i] && tT.Wi.update(() => s[i](n, r)));
          },
      ...
      class tV extends tw {
        mount() {
          this.unmount = (0, tg.z)(tS(this.node, !0), tS(this.node, !1));
        }
        unmount() {}
      }
      class tC extends tw {
      ...
      class tk extends tw {
        constructor() {
          (super(...arguments),
            ...
            (this.startPointerPress = (t, e) => {
              ...
              ((this.removeEndListeners = (0, tg.z)(n, r)),
                this.startPress(t, e));
            }),
            (this.startAccessiblePress = () => {
              let t = td(this.node.current, "keydown", (t) => {
                  "Enter" !== t.key ||
                    this.isPressing ||
                ...
                e = td(this.node.current, "blur", () => {
                  this.isPressing &&
                    tM("cancel", (t, e) => this.cancelPress(t, e));
                });
              this.removeAccessibleListeners = (0, tg.z)(t, e);
            }));
        }
        startPress(t, e) {
          this.isPressing = !0;
        ...
        mount() {
          let t = this.node.getProps(),
            e = tv(this.node.current, "pointerdown", this.startPointerPress, {
              passive: !(t.onTapStart || t.onPointerStart),
            }),
            i = td(this.node.current, "focus", this.startAccessiblePress);
          this.removeStartListeners = (0, tg.z)(e, i);
        }
        unmount() {
      ...
      let tW = "data-" + _("framerAppearId");
      var tU = i(5487);
      let tN = (t) => 1e3 * t,
        tz = (t) => t / 1e3,
        tH = { current: !1 },
        tZ = (t) => Array.isArray(t) && "number" == typeof t[0],
        tY = ([t, e, i, n]) => `cubic-bezier(${t}, ${e}, ${i}, ${n})`,
        tq = {
          linear: "linear",
          ease: "ease",
          easeIn: "ease-in",
        ...
        tK = {};
      for (let t in tX)
        tK[t] = () => (void 0 === tG[t] && (tG[t] = tX[t]()), tG[t]);
      let t_ = (t, e, i) =>
        (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
      function tJ(t, e, i, n) {
        if (t === e && i === n) return tD.Z;
        let r = (e) =>
          (function (t, e, i, n, r) {
            let s, o;
            let a = 0;
            do
              (s = t_((o = e + (i - e) / 2), n, r) - t) > 0 ? (i = o) : (e = o);
            while (Math.abs(s) > 1e-7 && ++a < 12);
            return o;
          })(e, 0, 1, t, i);
        return (t) => (0 === t || 1 === t ? t : t_(r(t), e, n));
      }
      let tQ = tJ(0.42, 0, 1, 1),
        t0 = tJ(0, 0, 0.58, 1),
        t1 = tJ(0.42, 0, 0.58, 1),
        t5 = (t) => Array.isArray(t) && "number" != typeof t[0],
        t3 = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
        t6 = (t) => (e) => 1 - t(1 - e),
        t2 = (t) => 1 - Math.sin(Math.acos(t)),
        t4 = t6(t2),
        t9 = t3(t4),
        t8 = tJ(0.33, 1.53, 0.69, 0.99),
        t7 = t6(t8),
        et = t3(t7),
        ee = {
          linear: tD.Z,
          ...
          backOut: t8,
          anticipate: (t) =>
            (t *= 2) < 1 ? 0.5 * t7(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
        },
        ei = (t) => {
          if (Array.isArray(t)) {
            (0, tU.k)(
          ...
          return "string" == typeof t
            ? ((0, tU.k)(void 0 !== ee[t], `Invalid easing type '${t}'`), ee[t])
            : t;
        };
      var en = i(4606),
        er = i(533);
      function es({
        ...
        let r = t5(n) ? n.map(ei) : ei(n),
          s = { done: !1, value: e[0] },
          o = (i && i.length === e.length ? i : (0, er.Y)(e)).map((e) => e * t),
          a = (0, en.s)(o, e, {
            ease: Array.isArray(r)
              ? r
              : e.map(() => r || t1).splice(0, e.length - 1),
          });
        return {
          ...
          a = { done: !1, value: s },
          {
            ...
            if (!ed(t, ec) && ed(t, eh)) {
              let i = (function ({
                ...
                let o = 1 - e;
                ((o = (0, el.u)(0.05, 1, o)),
                  (t = (0, el.u)(0.01, 10, tz(t))),
                  o < 1
                    ? ((r = (e) => {
                        let n = e * o,
                          r = n * t;
                        return 0.001 - ((n - i) / eu(e, o)) * Math.exp(-r);
                      }),
                      (s = (e) => {
                        let n = e * o * t,
      ...
      let ev = (t) => {
        ...
        return {
          ...
          stop: () => (0, tT.Pn)(e),
          now: () =>
            ef.frameData.isProcessing
              ? ef.frameData.timestamp
              : performance.now(),
        };
      };
      function eg(t) {
      ...
      let ey = { decay: em, inertia: em, tween: es, keyframes: es, spring: ep };
      function ex({
        autoplay: t = !0,
        delay: e = 0,
        driver: i = ev,
        ...
        b !== es &&
          "number" != typeof n[0] &&
          ((v = (0, en.s)([0, 100], n, { clamp: !1 })), (n = [0, 100]));
        let A = b({ ...d, keyframes: n });
        "mirror" === a &&
          (g = b({
            ...d,
            keyframes: [...n].reverse(),
        ...
        let w = "idle",
          ...
          S = null,
          V = null;
        null === A.calculatedDuration && s && (A.calculatedDuration = eg(A));
        let { calculatedDuration: C } = A,
          E = 1 / 0,
          D = 1 / 0;
        ...
        let M = 0,
          k = (t) => {
            if (null === S) return;
            y > 0 && (S = Math.min(S, t));
            let i = (M = null !== T ? T : (t - S) * y) - e,
              r = i < 0;
            ((M = Math.max(i, 0)), "finished" === w && null === T && (M = D));
            let l = M,
              u = A;
            if (s) {
              let t = M / E,
            ...
            let p =
              null === T &&
              ("finished" === w || ("running" === w && d) || (y < 0 && M <= 0));
        ...
        let B = {
          ...
          get duration() {
            return tz(
              null === A.calculatedDuration ? eg(A) : A.calculatedDuration,
            );
          },
          get speed() {
            return y;
      ...
      let eP = new Set([
        ...
        eA = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        ew = (t) => ({
          type: "spring",
          stiffness: 550,
      ...
      let eH = (t) => (e) => e.test(t),
        ...
        eq = [...eZ, ej.$, eC.P],
        eX = (t) => eq.find(eH(t));
      function eG(t, e, { delay: i = 0, transitionOverride: n, type: r } = {}) {
        let {
        ...
        for (let e in a) {
          ...
          if (window.HandoffAppearAnimations && !n.hasAnimated) {
            let i = t.getProps()[tW];
            i && (o.elapsed = window.HandoffAppearAnimations(i, e, n, tT.Wi));
          }
          n.start(
            eW(e, n, r, t.shouldReduceMotion && E.has(e) ? { type: !1 } : o),
          );
          let c = n.animation;
                      ...
                      e.map(({ animation: e, options: i }) =>
                        (function (t, e, i = {}) {
                          ...
                          if ((t.notify("AnimationStart", e), Array.isArray(e)))
                            n = Promise.all(e.map((e) => eK(t, e, i)));
                          else if ("string" == typeof e) n = eK(t, e, i);
                          else {
                            let r =
                              "function" == typeof e ? t$(t, e, i.custom) : e;
                            n = Promise.all(eG(t, r, i));
                          }
                ...
                function s(s, o) {
                  ...
                  for (let e = 0; e < eQ; e++) {
                    ...
                    let { prevResolvedValues: V = {} } = g,
                      C = { ...V, ...S },
                      E = (t) => {
                        ((w = !0), h.delete(t), (g.needsAnimating[t] = !0));
                      };
                    for (let t in C) {
                      let e = S[t],
                        i = V[t];
        ...
        constructor(t, e, { transformPagePoint: i } = {}) {
          if (
            ...
            (this.updatePoint = () => {
              ...
              let i = e8(this.lastMoveEventInfo, this.history),
                n = null !== this.startEvent,
                r =
                  ((t = i.offset),
                  (e = { x: 0, y: 0 }),
                  Math.sqrt(e6(t.x, e.x) ** 2 + e6(t.y, e.y) ** 2) >= 3);
              if (!n && !r) return;
              let { point: s } = i,
                { timestamp: o } = ef.frameData;
            ...
            (this.handlePointerMove = (t, e) => {
              ((this.lastMoveEvent = t),
                (this.lastMoveEventInfo = e4(e, this.transformPagePoint)),
          ...
          let n = e4(tm(t), this.transformPagePoint),
            { point: r } = n,
            { timestamp: s } = ef.frameData;
          this.history = [{ ...r, timestamp: s }];
          let { onSessionStart: o } = e;
          (o && o(t, e8(n, this.history)),
            (this.removeListeners = (0, tg.z)(
              tv(window, "pointermove", this.handlePointerMove),
              tv(window, "pointerup", this.handlePointerUp),
              tv(window, "pointercancel", this.handlePointerUp),
            )));
        }
        updateHandlers(t) {
          this.handlers = t;
      ...
      function e8({ point: t }, e) {
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ;
              i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > tN(0.1)));
      ...
      function ir(t, e = 0, i = 0.01) {
        return Math.abs(t - e) <= i;
      }
      function is(t, e, i, n = 0.5) {
        ((t.origin = n),
          (t.originPoint = (0, ie.C)(e.min, e.max, t.origin)),
          (t.scale = ii(i) / ii(e)),
          (ir(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1),
          (t.translate = (0, ie.C)(i.min, i.max, t.origin) - t.originPoint),
          (ir(t.translate) || isNaN(t.translate)) && (t.translate = 0));
      }
      function io(t, e, i, n) {
      ...
      function iP({ top: t, left: e, right: i, bottom: n }) {
        return { x: { min: e, max: i }, y: { min: t, max: n } };
      }
      function ib(t) {
        return void 0 === t || 1 === t;
      }
      function iA({ scale: t, scaleX: e, scaleY: i }) {
        return !ib(t) || !ib(e) || !ib(i);
      }
      function iw(t) {
        return iA(t) || iT(t) || t.z || t.rotate || t.rotateX || t.rotateY;
      }
      function iT(t) {
        var e, i;
      ...
      function iV(t, e = 0, i = 1, n, r) {
        ((t.min = iS(t.min, e, i, n, r)), (t.max = iS(t.max, e, i, n, r)));
      }
      function iC(t, { x: e, y: i }) {
      ...
      function iM(t, e, [i, n, r]) {
        let s = void 0 !== e[r] ? e[r] : 0.5,
          o = (0, ie.C)(t.min, t.max, s);
        iV(t, e[i], e[n], o, e.scale);
      }
      let ik = ["x", "scaleX", "originX"],
        iR = ["y", "scaleY", "originY"];
      function iL(t, e) {
        (iM(t.x, e, ik), iM(t.y, e, iR));
      }
      function ij(t, e) {
        return iP(
          (function (t, e) {
      ...
      class iB {
        ...
        start(t, { snapToCursor: e = !1 } = {}) {
          ...
          (i && !1 === i.isPresent) ||
            (this.panSession = new e2(
              t,
              {
                onSessionStart: (t) => {
                  (this.stopAnimation(),
                    e && this.snapToCursor(tm(t, "page").point));
                },
                onStart: (t, e) => {
                  let {
                    drag: i,
        ...
        updateAxis(t, e, i) {
          ...
          (this.constraints &&
            ...
            (s = (function (t, { min: e, max: i }, n) {
              return (
                void 0 !== e && t < e
                  ? (t = n ? (0, ie.C)(e, t, n.min) : Math.max(t, e))
                  : void 0 !== i &&
                    t > i &&
                    (t = n ? (0, ie.C)(i, t, n.max) : Math.min(t, i)),
                t
              );
          ...
          (t && h(t)
            ...
            : t && i
              ? (this.constraints = (function (
                  ...
                  return { x: ih(t.x, i, r), y: ih(t.y, e, n) };
                })(i.layoutBox, t))
              : (this.constraints = !1),
            (this.elastic = (function (t = 0.35) {
              return (
                !1 === t ? (t = 0) : !0 === t && (t = 0.35),
                { x: id(t, "left", "right"), y: id(t, "top", "bottom") }
              );
            })(e)),
            n !== this.constraints &&
              i &&
        ...
        resolveRefConstraints() {
          ...
          let s = (function (t, e, i) {
            ...
            o = { x: ic((t = r.layout.layoutBox).x, s.x), y: ic(t.y, s.y) };
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
            ...
            ((this.hasMutatedConstraints = !!t), t && (o = iP(t)));
          }
          return o;
        }
        startAnimation(t) {
          ...
          ix((t) => {
            ...
            if (e) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  r > n
                    ? (i = (0, it.Y)(e.min, e.max - n, t.min))
                    : n > r && (i = (0, it.Y)(t.min, t.max - r, e.min)),
                  (0, el.u)(0, 1, i)
                );
      ...
      let i$ = (t) => (e, i) => {
        t && tT.Wi.update(() => t(e, i));
      };
      class iW extends tw {
        constructor() {
          (super(...arguments), (this.removePointerDownListener = tD.Z));
        }
        onPointerDown(t) {
          this.session = new e2(t, this.createPanHandlers(), {
        ...
        mount() {
          this.removePointerDownListener = tv(
            this.node.current,
            "pointerdown",
      ...
      let iz = {
        correct: (t, e) => {
          ...
          let i = iN(t, e.target.x),
            n = iN(t, e.target.y);
          return `${i}% ${n}%`;
        },
      };
      class iH extends r.Component {
        componentDidMount() {
          let {
              visualElement: t,
              layoutGroup: e,
      ...
      let iY = {
        ...
        boxShadow: {
          correct: (t, { treeScale: e, projectionDelta: i }) => {
            ...
            let r = eC.P.createTransformer(t),
              s = "number" != typeof n[0] ? 1 : 0,
              o = i.x.scale * e.x,
              a = i.y.scale * e.y;
            ((n[0 + s] /= o), (n[1 + s] /= a));
            let l = (0, ie.C)(o, a, 0.5);
            return (
      ...
      let iX = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        iG = iX.length,
        iK = (t) => ("string" == typeof t ? parseFloat(t) : t),
        i_ = (t) => "number" == typeof t || B.px.test(t);
      function iJ(t, e) {
      ...
      let iQ = i1(0, 0.5, t4),
        i0 = i1(0.5, 0.95, tD.Z);
      function i1(t, e, i) {
        return (n) => (n < t ? 0 : n > e ? 1 : i((0, it.Y)(t, e, n)));
      }
      function i5(t, e) {
        ((t.min = e.min), (t.max = e.max));
      }
      function i3(t, e) {
        (i5(t.x, e.x), i5(t.y, e.y));
      }
      function i6(t, e, i, n, r) {
        return (
          (t -= e),
          (t = n + (1 / i) * (t - n)),
      ...
      function i2(t, e, [i, n, r], s, o) {
        !(function (t, e = 0, i = 1, n = 0.5, r, s = t, o = t) {
          if (
            (B.aQ.test(e) &&
              ((e = parseFloat(e)),
              (e = (0, ie.C)(o.min, o.max, e / 100) - o.min)),
            "number" != typeof e)
          )
            return;
          let a = (0, ie.C)(s.min, s.max, n);
          (t === s && (a -= e),
            (t.min = i6(t.min, e, i, a, r)),
            (t.max = i6(t.max, e, i, a, r)));
        })(t, e[i], e[n], e[r], e.scale, s, o);
      }
      let i4 = ["x", "scaleX", "originX"],
        i9 = ["y", "scaleY", "originY"];
      function i8(t, e, i, n) {
        (i2(t.x, e, i4, i ? i.x : void 0, n ? n.x : void 0),
          i2(t.y, e, i9, i ? i.y : void 0, n ? n.y : void 0));
      }
      function i7(t) {
        ...
        return class {
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) ||
                this.eventHandlers.set(t, new iq.L()),
              ...
              t(e, () => {
                ((this.root.updateBlockedByResize = !0),
                  ...
                  iU.hasAnimatedSinceResize &&
                    ((iU.hasAnimatedSinceResize = !1), this.nodes.forEach(nx)));
              });
            }
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    let r =
                      ...
                      l = !this.targetLayout || !ne(this.targetLayout, n) || i,
                      u = !e && i;
                    if (
          ...
          update() {
            ...
            this.isUpdating &&
              ...
              this.nodes.forEach(np),
              this.clearAllSnapshots(),
              tT.S6.update.process(ef.frameData),
              tT.S6.preRender.process(ef.frameData),
              tT.S6.render.process(ef.frameData));
          }
          didUpdate() {
          ...
          clearAllSnapshots() {
            (this.nodes.forEach(nv), this.sharedNodes.forEach(nw));
          }
          ...
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              (!e &&
                ...
                iw(n.latestValues) && iL(i, n.latestValues));
            }
            return (iw(this.latestValues) && iL(i, this.latestValues), i);
          }
          removeTransform(t) {
            let e = iy();
            i3(e, t);
            for (let t = 0; t < this.path.length; t++) {
              ...
              iA(i.latestValues) && i.updateSnapshot();
              let n = iy();
              (i3(n, i.measurePageBox()),
                i8(
                  e,
                  i.latestValues,
            ...
            return (iw(this.latestValues) && i8(e, this.latestValues), e);
          }
          setTargetDelta(t) {
            ((this.targetDelta = t),
          ...
          resolveTargetDelta(t = !1) {
            ...
            if (this.layout && (a || l)) {
              if (
                ((this.resolvedRelativeTargetAt = ef.frameData.timestamp),
                ...
                t && t.layout && 1 !== this.animationProgress
                  ? ((this.relativeParent = t),
                    ...
                    i3(this.relativeTarget, this.relativeTargetOrigin))
                  : (this.relativeParent = this.relativeTarget = void 0);
              }
              if (this.relativeTarget || this.targetDelta) {
                if (
                  ((this.target ||
                    ((this.target = iy()), (this.targetWithTransforms = iy())),
                  this.relativeTarget &&
                    this.relativeTargetOrigin &&
                    this.relativeParent &&
                    ...
                    : this.targetDelta
                      ? (this.resumingFrom
                          ...
                          : i3(this.target, this.layout.layoutBox),
                        iC(this.target, this.targetDelta))
                      : i3(this.target, this.layout.layoutBox),
                  this.attemptToResolveRelativeTarget)
                ) {
                  ...
                  1 !== this.animationProgress
                    ? ((this.relativeParent = t),
                      ...
                      (this.relativeTarget = iy()),
                      (this.relativeTargetOrigin = iy()),
                      iu(this.relativeTargetOrigin, this.target, t.target),
                      i3(this.relativeTarget, this.relativeTargetOrigin))
                    : (this.relativeParent = this.relativeTarget = void 0);
                }
                nh.resolvedTargetDeltas++;
          ...
          calcProjection() {
            ...
            if (
              ...
              return;
            (i3(this.layoutCorrected, this.layout.layoutBox),
              (function (t, e, i, n = !1) {
                let r, s;
                let o = i.length;
                if (o) {
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (!o || !o.style || "contents" !== o.style.display) &&
                      ...
                      s && ((e.x *= s.x.scale), (e.y *= s.y.scale), iC(t, s)),
                      n && iw(r.latestValues) && iL(t, r.latestValues));
                  }
                  ((e.x = iE(e.x)), (e.y = iE(e.y)));
                }
              ...
              (this.mixTargetDelta = (e) => {
                ...
                (nT(o.x, t.x, d),
                  ...
                  this.relativeTarget &&
                    ...
                    nS(n.y, u.y, a.y, d),
                    i &&
                      ne(this.relativeTarget, i) &&
                      (this.isProjectionDirty = !1),
                    i || (i = iy()),
                    i3(i, this.relativeTarget)),
                  l &&
                    ...
                    (function (t, e, i, n, r, s) {
                      ...
                      for (let r = 0; r < iG; r++) {
                        ...
                        (void 0 !== o || void 0 !== a) &&
                          ...
                          a || (a = 0),
                          0 === o || 0 === a || i_(o) === i_(a)
                            ? ((t[s] = Math.max((0, ie.C)(iK(o), iK(a), n), 0)),
                              (B.aQ.test(a) || B.aQ.test(o)) && (t[s] += "%"))
                            : (t[s] = a));
                      }
                      (e.rotate || i.rotate) &&
                        (t.rotate = (0, ie.C)(e.rotate || 0, i.rotate || 0, n));
                    })(s, r, this.latestValues, d, c, h)),
                  this.root.scheduleUpdateProjection(),
                  this.scheduleRender(),
          ...
          getProjectionStyles(t = {}) {
            ...
            if (this.needsReset)
              return (
                (this.needsReset = !1),
                (n.opacity = ""),
                (n.pointerEvents = tl(t.pointerEvents) || ""),
                ...
                this.options.layoutId &&
                  ((e.opacity =
                    void 0 !== this.latestValues.opacity
                      ...
                      : 1),
                  (e.pointerEvents = tl(t.pointerEvents) || "")),
                this.hasProjected &&
            ...
            return (
              this.options.layoutId &&
                (n.pointerEvents =
                  s === this ? tl(t.pointerEvents) || "" : "none"),
              n
            );
          }
          clearSnapshot() {
      ...
      function nT(t, e, i) {
        ((t.translate = (0, ie.C)(e.translate, 0, i)),
          (t.scale = (0, ie.C)(e.scale, 1, i)),
          (t.origin = e.origin),
          (t.originPoint = e.originPoint));
      }
      function nS(t, e, i, n) {
        ((t.min = (0, ie.C)(e.min, i.min, n)),
          (t.max = (0, ie.C)(e.max, i.max, n)));
      }
      function nV(t) {
      ...
      function nD(t, e, i) {
        return (
          "position" === t ||
          ("preserve-aspect" === t && !ir(ni(e), ni(i), 0.2))
        );
      }
      let nM = nc({
      ...
      function nj(t, e, i = 1) {
        ...
        return s ? s.trim() : (0, L.tm)(r) ? nj(r, e, i + 1) : r;
      }
      let nF = new Set([
          "width",
          "height",
        ...
        nB = (t) => nF.has(t),
        nO = (t) => Object.keys(t).some(nB),
        nI = (t) => t === F.Rx || t === B.px,
        n$ = (t, e) => parseFloat(t.split(", ")[e]),
        nW =
          (t, e) =>
          (i, { transform: n }) => {
        ...
        nY = (t, e, i, n) => {
          ...
          return (
            ...
            (r = e),
            (s = n),
            nO(r) ? nZ(t, r, i, s) : { target: r, transitionEnd: s }
          );
        },
        nq = { current: null },
        nX = { current: !1 },
      ...
      class n0 {
        constructor(
          ...
          ((this.current = null),
            ...
            (this.scheduleRender = () => tT.Wi.render(this.render, !1, !0)));
          ...
          for (let t in u) {
            let e = u[t];
            void 0 !== o[t] && M(e) && (e.set(o[t], !1), eU(l) && l.add(t));
          }
        }
          ...
          let i = E.has(t),
            n = e.on("change", (e) => {
              ((this.latestValues[t] = e),
                this.props.onUpdate && tT.Wi.update(this.notifyUpdate, !1, !0),
                i &&
                  this.projection &&
        ...
        update(t, e) {
          ...
          ((this.prevMotionValues = (function (t, e, i) {
            ...
            for (let r in e) {
              let s = e[r],
                o = i[r];
              if (M(s)) (t.addValue(r, s), eU(n) && n.add(r));
              else if (M(o))
                (t.addValue(r, (0, ez.B)(s, { owner: t })),
                  eU(n) && n.remove(r));
              else if (o !== s) {
                if (t.hasValue(r)) {
                  let e = t.getValue(r);
                  ...
                  t.addValue(r, (0, ez.B)(void 0 !== e ? e : s, { owner: t }));
                }
              }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = (0, ez.B)(e, { owner: this })), this.addValue(t, i)),
            i
          );
        }
        readValue(t) {
          ...
          let { initial: i } = this.props,
            n =
              "string" == typeof i || "object" == typeof i
                ? null === (e = tn(this.props, i)) || void 0 === e
                  ? void 0
                  : e[t]
                : void 0;
        ...
        on(t, e) {
          return (
            this.events[t] || (this.events[t] = new iq.L()),
            this.events[t].add(e)
          );
        }
        notify(t, ...e) {
                    ...
                    null === u &&
                      (u =
                        null !==
                          ...
                          : e[o]),
                    null != u &&
                      ("string" == typeof u && (eN(u) || eI(u))
                        ? (u = parseFloat(u))
                        : !eX(u) && eC.P.test(l) && (u = eO(o, l)),
                      t.addValue(o, (0, ez.B)(u, { owner: t })),
                      void 0 === i[o] && (i[o] = u),
      ...
      class n3 extends n1 {
        ...
        readValueFromInstance(t, e) {
          ...
          return ((e = Q.has(e) ? e : _(e)), t.getAttribute(e));
        }
        ...
        mount(t) {
          ((this.isSVGTag = K(t.tagName)), super.mount(t));
        }
      }
      let n6 = (t, e) =>
          S(t)
            ? new n3(e, { enableHardwareAcceleration: !1 })
            : new n5(e, { enableHardwareAcceleration: !0 }),
        n2 = {
          animation: { Feature: e1 },
          exit: { Feature: e3 },
          inView: { Feature: tO },
          tap: { Feature: tk },
          focus: { Feature: tC },
          hover: { Feature: tV },
          pan: { Feature: iW },
          drag: { Feature: iI, ProjectionNode: nR, MeasureLayout: iZ },
          layout: { ProjectionNode: nR, MeasureLayout: iZ },
        },
        n4 = (function (t) {
          function e(e, i = {}) {
            return (function ({
                ...
                if (!w && P.j) {
                  T.visualElement = (function (t, e, i, n) {
                    ...
                    return (
                      ...
                      (window.HandoffAppearAnimations ? l.L : r.useEffect)(
                        () => {
                          f &&
                            f.animationState &&
                  ...
                  T.visualElement &&
                    (y = T.visualElement.loadFeatures(x, n, t, i));
                }
        ...
        let u = (function (t, e, i) {
            let n = [],
              s =
                ...
                (function (t) {
                  if ("number" == typeof t);
                  else if ("string" == typeof t) return r.$.test(t) ? f : A;
        ...
        constructor(t, e = {}) {
          ((this.version = "10.12.12"),
            ...
            (this.updateAndNotify = (t, e = !0) => {
              ...
              let { delta: i, timestamp: s } = n.frameData;
              (this.lastUpdated !== s &&
                ((this.timeDelta = i),
                (this.lastUpdated = s),
                r.Wi.postRender(this.scheduleVelocityCheck)),
            ...
            (this.scheduleVelocityCheck = () =>
              r.Wi.postRender(this.velocityCheck)),
